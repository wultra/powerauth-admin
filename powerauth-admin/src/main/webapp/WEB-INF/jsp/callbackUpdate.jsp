...
<ol class="breadcrumb">
    ...
    <li class="active">Update Callback</li>
</ol>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <c:if test="${true eq auth_httpBasicPasswordSet}"><div class="col-sm-4" style="margin-top:8px">Password is set.</div></c:if>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <c:if test="${true eq auth_keyPasswordSet}"><div class="col-sm-4" style="margin-top: 8px">Password is set.</div></c:if>
                            </div>
                        </div>
                        <div class="form-group">
